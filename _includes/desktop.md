...
>**Click2Park Mobile**   
>If you needed to Release your Annual Permit space or Book a HotSpace while you are not near a PC, you can use an internet-enabled smartphone or tablet to access Click2Park Mobile by typing the same address into your phone's browser address bar: [{{ page.company_url }}]({{ page.company_url }}
...
<img class="media-object pull-left" style="background:#ff9900" src="/img/square.png" border="0"> orange|visitor|administrators
